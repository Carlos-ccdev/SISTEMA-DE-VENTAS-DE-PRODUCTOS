...
namespace CapaPresentacion
{
    public partial class frmCompras : Form
    {
        ...
        private void btnagregarproducto_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Los precios deben ser mayores a 0", "Mensaje", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                return;
            }
            ...
            if (precioventa < preciocompra * 1.05m)
            {
                MessageBox.Show("El precio de venta es muy cercano al de compra. Verifique el margen de ganancia.", "Advertencia", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
